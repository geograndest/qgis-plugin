    ...
    def set_tree_content(self, resources_tree):
        ...
        if resources_tree is None:
            QgsMessageLog.logMessage(u"Faute de fichier de configuration valide, aucune ressource ne peut être chargée "
                                     ...
                                     tag=u"DataGrandEst", level=Qgis.Warning)
...
##            i += 1
    ...
    def combine_states(self):
        ...
        while it.value():
            item = it.value()
            item_state = tree_state_text[item.item_data.ident] and tree_state_extent[item.item_data.ident]
    ...
    def filter_by_extent(self, currentindex):
        ...
        if currentindex == 1:
            ...
            bbox_map = [map_extent_epsg2154.xMinimum(), map_extent_epsg2154.xMaximum(), map_extent_epsg2154.yMinimum(), map_extent_epsg2154.yMaximum()]
            # expands all folders
            self.expandAll()
            ...
            while it.value():
                ...
                if bboxes is not None:
                    ...
                    intersects = 0
                    for bbox in bboxes:
                        intersects = intersects + self.check_if_intersects(bbox, bbox_map)
